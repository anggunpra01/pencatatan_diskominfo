...
@section('container')
<div  class="mb-3 mt-5 mb-sm-1 bg-darkborder shadow">
  <div class="row">
  ...
  <form action="/register" method="POST">
    ...
    <button type="submit" class="col-sm-3 mb-3 btn btn-dark btn-user btn-block  justify-content-center">Register</button>
  </form>
  </div>
</div>
