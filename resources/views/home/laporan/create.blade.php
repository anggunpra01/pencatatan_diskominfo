        ...
        <form class="user ">
            <div class="form-group row">
                <div class="col-sm-8 mb-5 mb-sm-3">
                    <input type="text" class="form-control form-control-user" id="namapelapor" name="namapelapor" placeholder="Nama Pelapor">
                </div>
              ...
              <div class="col-sm-8 mb-5 mb-sm-3">
                <input type="text" class="form-control form-control-user" id="nomorhp" name="nomorhp" placeholder="No HP">
              </div>
            </div>
